...
class HealthChecker
{
    ...
    {
        try {
            $dsn = $parameters['type'] . ":host=" . ($parameters['credentials']['host'] ?? "localhost") . ";port=" . ($parameters['credentials']['port'] ?? '3306') . ";dbname=" . $parameters['credentials']['database'];
            ...
            $status = 'MySQL dbName="' . $parameters['credentials']['database'] . '" status = ';
    ...
    {
        try {
            $pgdsn = $parameters['type'] . ":host=" . ($parameters['credentials']['host'] ?? "localhost") . ";port=" . ($parameters['credentials']['port'] ?? '5432') . ";dbname=" . $parameters['credentials']['database'] . ";user=" . $parameters['credentials']['user'] . ";password=" . $parameters['credentials']['password'];
            ...
            $timeMySQL = time() - $timeMySQL;
            $status = 'PostgreSQL dbName="' . $parameters['credentials']['database'] . '" status = ';
